...
OpenSteer::Vec3 SteerableBase::adjustRawSteeringForce (const Vec3& force,
...
void SteerableBase::applyBrakingForce (const float rate, const float deltaTime)
{
...
void SteerableBase::applySteeringForce (const Vec3& force,
...
void SteerableBase::regenerateLocalSpace (const Vec3& newVelocity,
                                                const float /* elapsedTime */)
{
...
void SteerableBase::regenerateLocalSpaceForBanking (const Vec3& newVelocity,
                                                          const float elapsedTime)
{
...
void SteerableBase::measurePathCurvature (const float elapsedTime)
{
    if (elapsedTime > 0)
    {
...
OpenSteer::Vec3 SteerableBase::predictFuturePosition (const float predictionTime) const
{
