...
#ifndef __OGRESTEER_STEERABLEBASE_
#define __OGRESTEER_STEERABLEBASE_
...
/**
	...
	\brief Concrete implementatio of the OpenSteer's AbstractVehicle.
	
	SimpleVehicle adds concrete vehicle methods to SimpleVehicle_2
	
 */

class SteerableBase: public SimpleVehicle_2
{
...
public:
	...
	// SteerableBase is basically a straight copy of the SimpleVehicle class implementation 
